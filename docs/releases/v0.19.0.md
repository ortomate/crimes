...
This is the third instance of the same shape in this codebase (**apparatus that fails closed on correct input**) after the eval scorer's
...
<span id="commented_out_code-matched-english-prose--airflow-8019--45"></span>
...
<span id="parallel_destination--2819-findings-from-134-files-now-gated-off"></span>
...
<span id="scope-class--15-airflow-files-carrying-44-findings-were-never-reportable"></span>
...
<span id="score_rationale-so-evidence-goes-back-to-being-receipts"></span>

### Separate score rationale from observed evidence
