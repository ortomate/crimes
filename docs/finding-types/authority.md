...
<span id="duplicated_policy--policy-doppelgänger"></span>
...
Dropping the path root allows equivalent checks to be compared. `user.role ===
...
<span id="contract_drift--contract-split-brain"></span>
...
<span id="config_drift--environment-roulette"></span>
...
<span id="pass_through_abstraction--abstraction-laundering"></span>
