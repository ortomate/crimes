...
<span id="11-crimes-init-wrote-a-js-only-config--36cb5fb"></span>
...
<span id="12-gitignore-was-never-implemented--3968042"></span>
...
<span id="13-dot-directories-were-skipped-and-reported-clean--3968042"></span>
...
<span id="14-scan-on-a-bad-path-exited-0--9d4d999"></span>
...
<span id="15-large_file-invented-a-line-per-file--9d4d999"></span>
...
<span id="16-or-trigger-detectors-disproved-their-own-headline--4d00849"></span>
...
<span id="17-the-quadratic-duplicate-block-sort--d098c37"></span>
...
<span id="18-context-printed-a-handle-explain-could-not-resolve--775996a"></span>
...
<span id="19110-fingerprint-collisions--ab58fdb-543a594"></span>
...
<span id="111-dependency_provenance_gap-checked-python-against-npm--5726216"></span>
...
<span id="1b-second-pass--the-fingerprint-class-closed"></span>

## 1b. Second pass: the fingerprint class, closed

A later session picked up §4.4a and finished it. Version `0.17.2`.

<span id="112-the-remaining-nine-colliding-detectors--29f6555-37404d6-c93b530"></span>
...
|---|---|---|
| pre-0.17.0 | n/a | 3,091 of 16,325 (18.9%) |
...
<span id="113-a-standing-gate-so-this-cannot-regress-a-third-time--29f6555"></span>
...
<span id="114-every-discriminated-finding-was-unignorable--1499b5e"></span>
...
<span id="115-a-re-scan-of-an-unchanged-tree-was-not-reproducible--3658750"></span>
...
<span id="116-weak_test_signal-did-not-follow-assertion-helpers--4456904-8db9487"></span>
...
<span id="117-coveragewarnings--the-scan-now-says-what-it-skipped--707ddf6-eedf2c3"></span>
...
<span id="118-blast_radius-called-a-reachability-closure-an-importer-count--e379126"></span>
...
<span id="0181-baseline--no-measurable-movement-and-that-is-not-the-same-as-no-effect"></span>
...
`6be5681`. `refs/remotes/origin/HEAD` is consulted first (guessing by name order would silently compare against the wrong
