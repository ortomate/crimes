...
async function main() {
  ...
  await writeFile(
    ...
    [
      ...
      "---",
      "",
      "`crimes` scans TypeScript, JavaScript and Python repositories for **change risk** and **agent risk**. Use its findings to plan edits, identify related code and choose tests.",
      "",
      ...
      "- [Agent setup and updates](/docs/skills/): install and refresh the bundled skills.",
      ...
      "",
      "Browse detector families under **Finding types** in the sidebar.",
      "",
